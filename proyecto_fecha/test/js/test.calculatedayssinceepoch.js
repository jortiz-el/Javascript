...
describe('Check primalty', function() {
    describe('', function() {
        context('Errores de formato', function() {
            it('should return FORMAT_ERROR for ""', function () {
            ...
            it('should return FORMAT_ERROR for "31dec1969"', function () {
                calculateDaysSinceEpoch("31dec1969").should.equal("Por favor, introducir la fecha en el formato solicitado");
            });
        ...
        context('Errores de fecha', function() {
            ...
            it('should return DATE_ERROR for "29feb2100"', function () {
        ...
        context('Fechas correctas', function() {
            ...
            it('should return "11.016" for "29feb2000"', function () {
                calculateDaysSinceEpoch("31apr1970").should.equal("11.016");
            });
        });
    });
}); 